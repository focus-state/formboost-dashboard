...
export class TeamMembersService {
     ...
     * Get details about a team.
     */
    public static apiV1TeamsTeamIdMembersGetTeamMembers<ThrowOnError extends boolean = false>(options: Options<ApiV1TeamsTeamIdMembersGetTeamMembersData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).get<ApiV1TeamsTeamIdMembersGetTeamMembersResponse, ApiV1TeamsTeamIdMembersGetTeamMembersError, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
     ...
     */
    public static apiV1TeamsTeamIdMembersMembershipIdRemoveMemberFromTeam<ThrowOnError extends boolean = false>(options: Options<ApiV1TeamsTeamIdMembersMembershipIdRemoveMemberFromTeamData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).delete<ApiV1TeamsTeamIdMembersMembershipIdRemoveMemberFromTeamResponse, ApiV1TeamsTeamIdMembersMembershipIdRemoveMemberFromTeamError, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
