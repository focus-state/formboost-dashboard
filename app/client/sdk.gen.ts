...
export class UserService {
    ...
    public static apiV1UsersMeEmailInitiateEmailChangeRequest<ThrowOnError extends boolean = false>(options: Options<ApiV1UsersMeEmailInitiateEmailChangeRequestData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).patch<ApiV1UsersMeEmailInitiateEmailChangeRequestResponse, ApiV1UsersMeEmailInitiateEmailChangeRequestError, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
     ...
     * Update user email.
     */
    public static apiV1UsersMeVerifyEmailChangeVerifyEmailChange<ThrowOnError extends boolean = false>(options: Options<ApiV1UsersMeVerifyEmailChangeVerifyEmailChangeData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).patch<ApiV1UsersMeVerifyEmailChangeVerifyEmailChangeResponse, ApiV1UsersMeVerifyEmailChangeVerifyEmailChangeError, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
