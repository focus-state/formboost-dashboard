...
export const apiV1UsersMeEmailInitiateEmailChangeRequestMutation = (options?: Partial<Options<ApiV1UsersMeEmailInitiateEmailChangeRequestData>>) => {
    const mutationOptions: UseMutationOptions<ApiV1UsersMeEmailInitiateEmailChangeRequestResponse, AxiosError<ApiV1UsersMeEmailInitiateEmailChangeRequestError>, Options<ApiV1UsersMeEmailInitiateEmailChangeRequestData>> = {
        mutationFn: async (localOptions) => {
...
export const apiV1UsersMeVerifyEmailChangeVerifyEmailChangeMutation = (options?: Partial<Options<ApiV1UsersMeVerifyEmailChangeVerifyEmailChangeData>>) => {
    const mutationOptions: UseMutationOptions<ApiV1UsersMeVerifyEmailChangeVerifyEmailChangeResponse, AxiosError<ApiV1UsersMeVerifyEmailChangeVerifyEmailChangeError>, Options<ApiV1UsersMeVerifyEmailChangeVerifyEmailChangeData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await UserService.apiV1UsersMeVerifyEmailChangeVerifyEmailChange({
                ...options,
                ...localOptions,
                throwOnError: true
            });
